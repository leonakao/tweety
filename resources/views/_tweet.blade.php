    ...
    <div>
        ...
        <div class="flex items-center mt-2">
            <div class="flex items-center mr-3">
                <svg viewBox="0 0 20 20" class="{{ $tweet->isLikedBy(current_user()) ? 'text-blue-500' : 'text-gray-500' }} w-4 mr-1">
            ...
            <div class="flex items-center">
                <svg viewBox="0 0 20 20" class="{{ $tweet->isDislikedBy(current_user()) ? 'text-blue-500' : 'text-gray-500' }} w-4 mr-1">
                    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" style="--darkreader-inline-fill:none; --darkreader-inline-stroke:none;" data-darkreader-inline-fill="" data-darkreader-inline-stroke="">
                        <g class="fill-current">
